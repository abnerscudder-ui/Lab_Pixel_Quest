...
public class HW2Enemy : MonoBehaviour
{
    //==================================================================================================================
    // Variables 
    //==================================================================================================================
    ...
    //Movement Controls 
    public Rigidbody2D Componentrigidbody2D; //The rigidbody that will move the bullet 
    ...
    {
        Componentrigidbody2D.velocity = newSpeed * Random.Range(minSpeed,maxSpeed);
    }
